<?php
     ...
     $Connexion = $db->getConnection();
      ...
      if($Connexion){
            ...
            //ajouter un electeur depuis le dashboard admin
        
        

    if(isset($_POST['ajouter_electeur_via_admin'])){
        ...
        if($Connexion){
            ...
            if($sql_verify != $mail_electeur){
                ...
                $_SESSION['electeur_ajoute'] = "Electeur enregistré avec succes";
                header('Location:../../dashboard_admin.php');
                

            }else if($sql_verify === $mail_electeur) {

                echo "electeur déja présent dans la base de données";
